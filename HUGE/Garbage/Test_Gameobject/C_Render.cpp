...
void C_Render::Initialize()
{
	...
	mSEContext.material.ambient = { 0.8f,0.8f,0.8f,1.0f };
	mSEContext.material.specular = { 0.8f,0.8f,0.8f,1.0f };
	mSEContext.material.diffuse = { 0.8f,0.8f,0.8f,1.0f };
	mSEContext.material.power = 1.0f;

	mSEContext.diffuseMap = TextureManager::Get()->LoadTexture("fruit42.png");
	mSEContext.normalMap = TextureManager::Get()->LoadTexture("earth_normal.jpg");
...
void C_Render::Render()
{
	...
	mShaderEffect->SetContextInfo(&mSEContext);
	//
...
void C_Render::DebugUI()
{
	if (ImGui::CollapsingHeader("C_Render"))
	{
		...
		{
			ImGui::ColorEdit4("Ambient##Material", &mSEContext.material.ambient.r);
			ImGui::ColorEdit4("Diffuse##Material", &mSEContext.material.diffuse.r);
			ImGui::ColorEdit4("Specular##Material", &mSEContext.material.specular.r);
			ImGui::DragFloat("Power##Material", &mSEContext.material.power, 1.0f, 0.0f, 100.0f);
