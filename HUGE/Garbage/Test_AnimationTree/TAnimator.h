...
public:
	...
	void SetTransitionActive(bool transition);
	void SetBlendingActive(bool blend);
	void SetPlayActive(bool play);
...
private:
	...
	char in_anim_file_path[file_path_buffer_size];
 	...
 	const wchar_t* PATH_ANIMCLIPS = L"../../Assets/Models/Movement/walking.animset";
	const wchar_t* PATH_ANIMCLIPS_2 = L"../../Assets/Models/Movement/walkingleftturn.animset";
	const wchar_t* PATH_ANIMCLIPS_3 = L"../../Assets/Models/Movement/walkingrightturn.animset";
	const wchar_t* PATH_ANIMCLIPS_4 = L"../../Assets/Models/Movement/walkingturn180l.animset";
	const wchar_t* PATH_ANIMCLIPS_5 = L"../../Assets/Models/Movement/walkingturn180r.animset";
	const wchar_t* PATH_ANIMCLIPS_6 = L"../../Assets/Models/Movement/idle.animset";
	const wchar_t* PATH_ANIMCLIPS_7 = L"../../Assets/Models/Movement/running.animset";
