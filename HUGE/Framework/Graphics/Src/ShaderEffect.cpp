...
void H::Graphics::ShaderEffect::Bind()
{
	Bind_VS_and_PS();
	Bind_Other_Buffers();
...
void H::Graphics::ShaderEffect::UnBind()
{
...
void H::Graphics::ShaderEffect::Bind_VS_and_PS()
{
	mVertexShader.Bind();
	mPixelShader.Bind();
}
...
void H::Graphics::ShaderEffect_Standard::SetContextInfo( ShaderEffectContext * context)
{
	mContext = static_cast<SE_Context_Standard*>(context);
...
void H::Graphics::ShaderEffect_Standard::Render(ShaderEffectContext * context)
{
